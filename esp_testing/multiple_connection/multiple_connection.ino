...
char* ssid = "Vj"; //Put your Wi-Fi ssdid here
char* password = "Google@123"; //Your Wi-Fi Password
String light1 = "0";
String light2 = "0";
String light3 = "0";
String light4 = "0";
...
IPAddress staticIP(192, 168, 43, 12); //ESP static ip
IPAddress gateway(192, 168, 43, 141);   //IP Address of your WiFi Router (Gateway)
...
String html ="<!DOCTYPE html> <html> <body> <center><h2>whileofone</h2></center><h1>Light Level</h1> <head><meta http-equiv=\"refresh\" content=\"2\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"></head> <div id=\"light\">";
html += LDRReading;
